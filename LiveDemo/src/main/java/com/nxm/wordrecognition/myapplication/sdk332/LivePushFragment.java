...
public class LivePushFragment extends Fragment implements Runnable {
    ...
    private Main3Activity.PauseState mStateListener = null;
...
//        mTopBar.setVisibility(mAudio ? View.GONE : View.VISIBLE);
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (mAlivcLivePusher == null) {
                if (getActivity() != null) {
                    mAlivcLivePusher = ((Main3Activity) getActivity()).getLivePusher();
                }
                        ...
                        switch (id) {
                            ...
                            case R.id.preview_button:
                                ...
                                if (mSurfaceView == null && getActivity() != null) {
                                    mSurfaceView = ((Main3Activity) getActivity()).getPreviewView();
                                }
                                if (!isPreview) {
    ...
    public void setStateListener(Main3Activity.PauseState listener) {
    ...
    public void run() {
        if (mIsPushing != null && mAlivcLivePusher != null) {
            ...
            if (isPushing)
                mIsPushing.setText("正在推流……");
            else
                mIsPushing.setText("准备推流……");
        }
